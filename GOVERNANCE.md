...
`cloud-itonami-isic-3091` is an OSS open-business blueprint for motorcycle plant operations coordination.

## Maintainers
Maintainers may merge changes that preserve these invariants:
- a welding/assembly/test-bench-equipment action the governor refuses is never dispatched to hardware.
- the Motorcycle Plant Operations Governor remains independent of the advisor.
...
- bypassing welding/assembly/test-bench-equipment-control or record policy checks

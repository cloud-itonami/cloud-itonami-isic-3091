# Operator Quickstart — Manufacture of motorcycles

Shortest path from clone to a verified local dry-run for **ISIC 3091** (`cloud-itonami-isic-3091`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-3091.git
cd cloud-itonami-isic-3091
```
...
- Blueprint governor key: `motorcycle-plant-operations-governor`
- Likely source path: `motomfg.governor.cljc`

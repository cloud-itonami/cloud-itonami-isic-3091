# Business Model: Manufacture of motorcycles
...
## Classification
- Repository: `cloud-itonami-isic-3091` ([github.com/cloud-itonami/cloud-itonami-isic-3091](https://github.com/cloud-itonami/cloud-itonami-isic-3091))
- ISIC Rev.5: `3091` — Manufacture of motorcycles
- Domain: `:motorcycle/manufacturing`
- Social impact: :worker-safety :rider-safety :road-safety :emissions-compliance
- Actor: `:motorcycle-plant-operations-governor` — an independent Governor in the fleet's Sealed-LLM
...
## Customer
An operator running this vertical as an OSS business — :motorcycle/manufacturing — who wants
...
One managed tenant (:motorcycle/manufacturing):
...
- Do not bypass the `:motorcycle-plant-operations-governor` for production decisions.

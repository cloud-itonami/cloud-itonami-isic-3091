(ns motomfg.phase
  "Phase 0->3 staged rollout for the motorcycle-manufacturing
  ...
  consequence (a welding/assembly/test-bench maintenance window means
  production downtime, and the equipment ends up actually touched); it
  is always a human plant supervisor's call.
  `motomfg.governor`'s `equipment-actuate-blocked-violations`
...
(defn verdict->disposition
  "Map a Motorcycle Plant Operations Governor verdict to a base
